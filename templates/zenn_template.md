---
title: "（開発日記 #[連番]）" # LLMが内容に基づいてタイトルを生成
emoji: "📝"
...
## 基本ルール
1.  **Frontmatter**:
    *   `title`: 開発日記の内容を要約した具体的なタイトルを生成し、`（開発日記 #[連番]）` の形式で設定してください。
...
3.  **関連リンク**: メッセージボックスの直後に、「前回の開発日記」へのリンクのみを含むセクションを追加してください。（リンクURLは提供されます）
4.  **文体と構成**:
